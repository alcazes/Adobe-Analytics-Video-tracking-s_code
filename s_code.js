...
//INPUT YOUR TRACKING SERVER AND YOUR VISITOR NAMESPACE
s.trackingServer="[TRACKING_SERVER]"
s.visitorNamespace="[VISITOR NAMESPACE]"


/*BEGINNING OF MEDIA MODULE CONFIGURATION*/
/*
The settings and mapping until END OF MEDIA MODULE CONFIGURATION
was specific to the settings enable in my report suite in the Admin section
you need to modify the values to your settings
*/
s.loadModule("Media")
s.Media.onLoad = function(s,m) {
	/*Configure Media Module Functions */
s.Media.autoTrack= true;
s.Media.trackVars="events,prop2,eVar2,eVar3,eVar4";
s.Media.trackEvents="event2,event3,event4,event5,event6,event7,event8"
...
"a.contentType":"eVar4",
"a.media.timePlayed":"event2",
"a.media.view":"event3",
"a.media.segmentView":"event5",
"a.media.complete":"event4",
"a.media.milestones":{
25:"event6",
50:"event7",
75:"event8"
...
/*END OF MEDIA MODULE CONFIGURATION*/
